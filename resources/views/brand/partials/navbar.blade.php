...
<header class="bg-black border-b border-neutral-800/50 h-20 px-6 flex items-center justify-between gap-4 sticky top-0 z-20">
    ...
    <div class="flex items-center gap-3">
        ...
        <!-- Avatar -->
        <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-brand to-brand flex items-center justify-center text-white text-sm font-bold shadow-sm cursor-default">
