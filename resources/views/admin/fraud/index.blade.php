...
@php
$alerts = [
    ['account'=>'bot_views99','type'=>'Bot Activity','detail'=>'Tayangan naik 50K dalam 2 menit secara anomali','risk'=>'Kritis','time'=>'5 menit lalu','status'=>'Aktif'],
    ...
    ['account'=>'brandspoof_id','type'=>'Merek Spoofing','detail'=>'Menggunakan logo brand tanpa izin di konten','risk'=>'Tinggi','time'=>'5 jam lalu','status'=>'Diblokir'],
    ['account'=>'view_buyer22','type'=>'Tayangan Manipulation','detail'=>'Mencurigai pembelian views dari luar platform','risk'=>'Sedang','time'=>'1 hari lalu','status'=>'Diperiksa'],
];
